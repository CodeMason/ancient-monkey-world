/* $Id: j2DClient.java,v 1.433 2013/05/17 20:19:57 kiheru Exp $ */
/***************************************************************************
...
import games.stendhal.client.core.GameLoop;
import games.stendhal.client.core.world.GameObjects;
import games.stendhal.client.core.GameScreen;
import games.stendhal.client.core.event.PerceptionListenerImpl;
import games.stendhal.client.core.StaticGameLayers;
import games.stendhal.client.StendhalClient;
import games.stendhal.client.UserContext;
import games.stendhal.client.core.world.World;
...
import games.stendhal.client.engine.sound.facade.SoundGroup;
import games.stendhal.client.engine.sound.facade.SoundSystemFacade;
import games.stendhal.client.engine.sound.nosound.NoSoundFacade;
		...
		if (soundSystemFacade == null) {
			try {
				if ((DataLoader.getResource("data/sound/harp-1.ogg") != null)
					...
					soundSystemFacade = new games.stendhal.client.engine.sound.sound.SoundSystemFacadeImpl();
				} else {
