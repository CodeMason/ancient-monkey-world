/* $Id: TileStore.java,v 1.67 2013/04/23 22:31:47 kiheru Exp $ */
/***************************************************************************
 ...
 *                                                                         *
 ***************************************************************************/
package games.stendhal.client.core.graphics;

import games.stendhal.client.core.util.MemoryCache;
import games.stendhal.client.engine.graphics.sprite.DataLoader;
import games.stendhal.client.engine.graphics.sprite.Sprite;
import games.stendhal.client.engine.graphics.sprite.SpriteStore;
import games.stendhal.client.engine.graphics.sprite.SpriteTileset;
import games.stendhal.client.engine.graphics.sprite.Tileset;
import games.stendhal.client.engine.graphics.sprite.TilesetAnimationMap;
import games.stendhal.client.engine.graphics.sprite.TilesetGroupAnimationMap;
...
public class TileStore implements Tileset {
	 ...
	 */
	public boolean validate(final Color color, final Composite blend) {
		if (!validated) {
			if (!tilesets.isEmpty()) {
